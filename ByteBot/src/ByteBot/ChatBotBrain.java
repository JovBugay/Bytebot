...
public class ChatBotBrain {
    ...
    */
    ...
    final private String cipherText = "ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟ$ΠΡΣ*ΤFΥΦЖЛРСТеймпёѬѥѧѿ҂Ѹѳ+Ҟ";
    ...
    */
    public String analyzeChat(String message){               
            ...
            responses.add("Hi! I am BYTEBOT, your personal chatbot! please ask me what can I do");
            knowledgeBase.add("what can you do?");
            responses.add("just type in -search- to search on google, -music- to play music, -draw- to draw");
            knowledgeBase.add("age");
            responses.add("Hi! I am 1 year old");
    ...
    */
    ...
    public static void draw(){
        try{
        Process program = Runtime.getRuntime().exec("D:\\Program Files\\Benbox\\3.7.99\\bin\\benbox.exe");
